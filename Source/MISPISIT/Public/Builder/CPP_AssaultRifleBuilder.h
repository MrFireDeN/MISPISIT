...
#include "CPP_AssaultRifleBuilder.generated.h"

UCLASS(BlueprintType)
class MISPISIT_API ACPP_AssaultRifleBuilder : public AActor, public ICPP_WeaponBuilder
{
	GENERATED_BODY()

public:
	ACPP_AssaultRifleBuilder();
